...
class GeneratedScene(MovingCameraScene):
    def construct(self):
        ...
        pc_uncountable_yet_zero_length.shift([-2.66666662, 2.93333329, 0])
        ...
        pc_original_interval = RoundedRectangle(corner_radius=0.01481481, width=8.44444431, height=0.2074074).set_fill("#252722", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_original_interval.shift([0.0, 0.96296295, 0])
        pc_ref_9e40e534 = pc_original_interval.copy()
        pc_first_left_interval = RoundedRectangle(corner_radius=0.01481481, width=2.81481477, height=0.2074074).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_first_left_interval.shift([-2.81481477, 0.17777777, 0])
        pc_ref_e154d848 = pc_first_left_interval.copy()
        pc_first_right_interval = RoundedRectangle(corner_radius=0.01481481, width=2.81481477, height=0.2074074).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_first_right_interval.shift([2.81481477, 0.17777777, 0])
        pc_ref_8ab03d9b = pc_first_right_interval.copy()
        pc_first_removal = RoundedRectangle(corner_radius=0.01481481, width=2.81481477, height=0.2074074).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.35)
        pc_first_removal.shift([0.0, 0.17777777, 0])
        pc_ref_a1bebae4 = pc_first_removal.copy()
        pc_second_generation_i = RoundedRectangle(corner_radius=0.01481481, width=0.9185185, height=0.17777777).set_fill("#252722", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_second_generation_i.shift([-3.7629629, -0.6074074, 0])
        pc_ref_46df2fb2 = pc_second_generation_i.copy()
        pc_second_generation_ii = RoundedRectangle(corner_radius=0.01481481, width=0.9185185, height=0.17777777).set_fill("#252722", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_second_generation_ii.shift([-1.86666664, -0.6074074, 0])
        pc_ref_20dcb549 = pc_second_generation_ii.copy()
        pc_second_generation_iii = RoundedRectangle(corner_radius=0.01481481, width=0.9185185, height=0.17777777).set_fill("#252722", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_second_generation_iii.shift([1.86666664, -0.6074074, 0])
        pc_ref_516af869 = pc_second_generation_iii.copy()
        pc_second_generation_iv = RoundedRectangle(corner_radius=0.01481481, width=0.9185185, height=0.17777777).set_fill("#252722", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_second_generation_iv.shift([3.7629629, -0.6074074, 0])
        pc_ref_776d72d2 = pc_second_generation_iv.copy()
        pc_second_removal = RoundedRectangle(corner_radius=0.01481481, width=0.94814813, height=0.17777777).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.3)
        ...
        pc_third_generation_1 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_1.shift([-4.07407401, -1.2148148, 0])
        pc_ref_a9bfcdfe = pc_third_generation_1.copy()
        pc_third_removal_1 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32)
        pc_third_removal_1.shift([-3.7629629, -1.2148148, 0])
        pc_ref_c6f19501 = pc_third_removal_1.copy()
        pc_third_generation_2 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_2.shift([-3.4518518, -1.2148148, 0])
        pc_ref_eea547fd = pc_third_generation_2.copy()
        pc_third_generation_3 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_3.shift([-2.17777774, -1.2148148, 0])
        pc_ref_cd151d5d = pc_third_generation_3.copy()
        pc_third_removal_2 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32)
        pc_third_removal_2.shift([-1.86666664, -1.2148148, 0])
        pc_ref_ecf40f6a = pc_third_removal_2.copy()
        pc_third_generation_4 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_4.shift([-1.55555553, -1.2148148, 0])
        pc_ref_80525346 = pc_third_generation_4.copy()
        pc_third_generation_5 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_5.shift([1.55555553, -1.2148148, 0])
        pc_ref_78c0c13c = pc_third_generation_5.copy()
        pc_third_removal_3 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32)
        pc_third_removal_3.shift([1.86666664, -1.2148148, 0])
        pc_ref_12f689d3 = pc_third_removal_3.copy()
        pc_third_generation_6 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_6.shift([2.17777774, -1.2148148, 0])
        pc_ref_3db174ef = pc_third_generation_6.copy()
        pc_third_generation_7 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        pc_third_generation_7.shift([3.4518518, -1.2148148, 0])
        pc_ref_6112badb = pc_third_generation_7.copy()
        pc_third_removal_4 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32)
        pc_third_removal_4.shift([3.7629629, -1.2148148, 0])
        pc_ref_38f9043c = pc_third_removal_4.copy()
        pc_third_generation_8 = RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#315866", opacity=1.0).set_stroke("#252722", width=1.75)
        ...
        pc_measure_note.shift([4.29629623, -2.37037033, 0])
        ...
        self.play(Succession(Wait(0.2), group=Group(), run_time=0.2))
        self.play(AnimationGroup(Transform(pc_third_removal_1, pc_ref_c6f19501.copy().become(RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32).shift([-3.7629629, -1.2148148, 0])).set_opacity(0.0), run_time=1.1, rate_func=rate_functions.ease_out_quart), Transform(pc_third_removal_2, pc_ref_ecf40f6a.copy().become(RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32).shift([-1.86666664, -1.2148148, 0])).set_opacity(0.0), run_time=1.1, rate_func=rate_functions.ease_out_quart), Transform(pc_third_removal_3, pc_ref_12f689d3.copy().become(RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32).shift([1.86666664, -1.2148148, 0])).set_opacity(0.0), run_time=1.1, rate_func=rate_functions.ease_out_quart), Transform(pc_third_removal_4, pc_ref_38f9043c.copy().become(RoundedRectangle(corner_radius=0.01481481, width=0.29629629, height=0.14814815).set_fill("#252722", opacity=1.0).set_stroke("#71402d", width=1.75).set_opacity(0.32).shift([3.7629629, -1.2148148, 0])).set_opacity(0.0), run_time=1.1, rate_func=rate_functions.ease_out_quart), lag_ratio=0, run_time=1.1))
